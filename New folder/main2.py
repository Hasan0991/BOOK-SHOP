...
rad_but3 = Radiobutton(frame_option, text='Add Product', width=10, variable=var1, font='Arial 12', value=2, )
...
lbl_add = Label(frame_add_book, text='Add new product', font='Calibri 20', fg='red')
...
wallet_btn = Button(frame_user_acc, text='Wallet', width=17, height=2, command=switch_to_wallet)
